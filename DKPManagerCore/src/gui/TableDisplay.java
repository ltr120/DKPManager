...
public class TableDisplay extends JPanel {
    ...
    private void setTableHeader() {
        JLabel label = new JLabel(
                "DKP Summary: (Hint: Double click on one character's "
                        + "name to see detailed DKP event log.)");
    ...
    private void setDKPTable() {
        ...
        table_.setDefaultRenderer(Object.class,
                MyClassColorRenderer.getInstance());
    ...
    private class CharacterPanel extends JPanel {
        ...
        private void preSet() {
            ...
            // Character Class
            l = new JLabel("Class: ", SwingConstants.RIGHT);
            northPanel.add(l);
            characterClass = new JLabel();
            northPanel.add(characterClass);
        ...
        private void reloadContent() {
            ...
            characterClass.setText(c.getWOWCharacterClass().name());
